...
public class GameScene : BaseScene
{
    ...
    public override bool Init()
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            Managers.Object.Spawn<Hero>(new Vector3Int(-10 + Random.Range(-5, 5), -5 + Random.Range(-5, 5), 0), heroID);
        }

        {
            Managers.Object.Spawn<Monster>(new Vector3(0, 1, 0), MONSTER_GOBLIN_ARCHER_ID);
            Managers.Object.Spawn<Monster>(new Vector3(0, 1, 0), MONSTER_GOBLIN_ARCHER_ID);
            Managers.Object.Spawn<Monster>(new Vector3(0, 1, 0), MONSTER_GOBLIN_ARCHER_ID);
